...
const Command = require('mariadb/lib/cmd/command.js');
const Errors = require('mariadb/lib/misc/errors.js');
const Capabilities = require('mariadb/lib/const/capabilities.js');
const Handshake = require('mariadb/lib/cmd/handshake/auth/handshake.js');
const ServerStatus = require('mariadb/lib/const/server-status.js');
const StateChange = require('mariadb/lib/const/state-change.js');
const Collations = require('mariadb/lib/const/collations.js');
const Crypto = require('crypto');
const utils = require('mariadb/lib/misc/utils.js');
const tls = require('tls');
const authenticationPlugins = {
  mysql_native_password: require('mariadb/lib/cmd/handshake/auth/native-password-auth.js'),
  mysql_clear_password: require('mariadb/lib/cmd/handshake/auth/clear-password-auth.js'),
  client_ed25519: require('mariadb/lib/cmd/handshake/auth/ed25519-password-auth.js'),
  parsec: require('mariadb/lib/cmd/handshake/auth/parsec-auth.js'),
  dialog: require('mariadb/lib/cmd/handshake/auth/pam-password-auth.js'),
  sha256_password: require('mariadb/lib/cmd/handshake/auth/sha256-password-auth.js'),
  caching_sha2_password: require('mariadb/lib/cmd/handshake/auth/caching-sha2-password-auth.js')
};
