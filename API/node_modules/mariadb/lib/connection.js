...
const PacketInputStream = require('mariadb/lib/io/packet-input-stream');
const PacketOutputStream = require('mariadb/lib/io/packet-output-stream');
const CompressionInputStream = require('mariadb/lib/io/compression-input-stream');
const CompressionOutputStream = require('mariadb/lib/io/compression-output-stream');
const ServerStatus = require('mariadb/lib/const/server-status');
const ConnectionInformation = require('mariadb/lib/misc/connection-information');
const tls = require('tls');
const Errors = require('mariadb/lib/misc/errors');
const Utils = require('mariadb/lib/misc/utils');
const Capabilities = require('mariadb/lib/const/capabilities');
const ConnectionOptions = require('mariadb/lib/config/connection-options');

/*commands*/
const Authentication = require('mariadb/lib/cmd/handshake/authentication');
const Quit = require('mariadb/lib/cmd/quit');
const Ping = require('mariadb/lib/cmd/ping');
const Reset = require('mariadb/lib/cmd/reset');
const Query = require('mariadb/lib/cmd/query');
const Prepare = require('mariadb/lib/cmd/prepare');
const OkPacket = require('mariadb/lib/cmd/class/ok-packet');
const Execute = require('mariadb/lib/cmd/execute');
const ClosePrepare = require('mariadb/lib/cmd/close-prepare');
const BatchBulk = require('mariadb/lib/cmd/batch-bulk');
const ChangeUser = require('mariadb/lib/cmd/change-user');
const { Status } = require('mariadb/lib/const/connection_status');
const LruPrepareCache = require('mariadb/lib/lru-prepare-cache');
const fsPromises = require('fs').promises;
const Parse = require('mariadb/lib/misc/parse');
const Collations = require('mariadb/lib/const/collations');
