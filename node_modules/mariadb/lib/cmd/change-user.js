...
const Ed25519PasswordAuth = require('mariadb/lib/cmd/handshake/auth/ed25519-password-auth');
const NativePasswordAuth = require('mariadb/lib/cmd/handshake/auth/native-password-auth');
...
class ChangeUser extends Authentication {
  ...
  start(out, opts, info) {
    ...
    if (info.clientCapabilities & Capabilities.CONNECT_ATTRS) {
      ...
      let packageJson = require('mariadb/package.json');
